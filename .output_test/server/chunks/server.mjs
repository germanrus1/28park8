import { getCurrentInstance, version, defineComponent, h, inject, computed, unref, ref, resolveComponent, shallowRef, reactive, isReadonly, Transition, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, nextTick } from 'vue';
...
const _routes = [
  {
    name: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.name) ?? "finish",
    path: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) ?? "/finish",
    children: [],
    meta: __nuxt_page_meta$2,
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./finish-ade5618a.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "generator",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/generator",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./generator-b9e22b09.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-e1008122.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-d057824e.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component-b8374163.mjs').then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import('./island-renderer-88444cf4.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
